            ...
            <div className="row">
                <div className="col-12">
                    <div className="experience-bx wow zoomIn">
                        ...
                        <Row>
                            <Col sm={3}>
                            <ListGroup style={{width: "50%"}} className = "justify-content-center align-items-center">
                                <ListGroup.Item varient="primary" id="list-group-nav-pills" action href="#link1">
                                Education
                                </ListGroup.Item>
                                <ListGroup.Item varient="secondary" action href="#link2">
                                Experience
                                </ListGroup.Item>
                            </ListGroup>
                            </Col>
                            ...
                            <Tab.Content>
                                ...
                                <p>
                                Leads data engineering projects from requirements gathering to ensuring data operations run smoothly, data arrives correctly, and data privacy standards are adhered to. Delivers features to machine learning platforms utilizing technologies and languages such as Scala, Python, Dataflow, and Google Cloud Platform.                                </p>
                                <p>
