...
export const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
          ...
          description: "Developed a web application that allows users to apply neural style transfer to their images. The application utilizes deep learning techniques to blend the style of one image with the content of another, creating unique and artistic results.",
          imgUrl: projImg3,
              ...
              <div>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp">
                    ...
                    <ListGroup>
                                <ListGroup.Item varient="primary" id="list-group-nav-pills" action href="#link3">
                                Overview
                                </ListGroup.Item>
                                <ListGroup.Item varient="secondary" action href="#link4">
                                Key Features
                                </ListGroup.Item>
                                <ListGroup.Item varient="secondary" action href="#link5">
                                Focus
                                </ListGroup.Item>
                    </ListGroup>
                    </Col>
                    ...
                    <p>
                      <span style={{color: "white", fontWeight: "bold"}}>
                        Cheapest Groceries:
                      </span> This upcoming application is designed to help users find the most affordable groceries from various UK supermarkets while providing culinary inspiration through a social platform.
                      </p>
